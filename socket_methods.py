...
try:
    ...
    print("gethostnamebyname:", socket.gethostbyname("www.python.org"))
    print("gethostnamebyname_ex:", socket.gethostbyname_ex("www.python.org"))
    print("gethostnamebyaddr:", socket.gethostbyaddr("8.8.8.8"))
